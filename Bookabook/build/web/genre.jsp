<%-- 
    Document   : genre
    Created on : Mar 9, 2024, 11:54:35 PM
    Author     : ADMIN
--%>
    ...
    <body>
        <jsp:include page="template/menu.jsp"></jsp:include>
            ...
            <div class="container-fluid page-header py-5">
                <h1 class="text-center text-white display-6">Genre</h1>
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="home">Home</a></li>
                    <li class="breadcrumb-item active text-white">Genre</li>
                </ol>
            </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-xl-3">
                                    <form id="form" action="shop" method="get">
                                        ...
                                        <!--<select onchange="submit()" id="subject" name="subject">-->
                                        <!--<option name="All" value="">All subjects</option>-->
                                        <%--<c:forEach items="${subjectList}" var="s">--%>

                        <!--<option ${(subject==s.getSubjectId())?'selected':" "} name="${s.getSubjectId()}" value="${s.getSubjectId()}">${s.getSubjectName()}</option>-->
                                        <%--</c:forEach>--%>
                                        </select>
                                    </div>
                                </form>
