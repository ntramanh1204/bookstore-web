<%-- 
    ...
    Created on : Mar 5, 2024, 4:47:05 PM
    Author     : ADMIN
--%>
    ...
    <body>
        <jsp:include page="template/menu.jsp"></jsp:include>
            ...
            <main class="form-signin d-flex justify-content-center align-items-center" style="height: 100vh;">
                <form style="width: 25em;" action="changePassword" method="post">
                    <h1 class="h3 mb-3 fw-normal">Change ${sessionScope.account.username}'s Password</h1>

                <div class="form-floating">
                    <input name="oldPass" type="password" class="form-control" id="floatingInput" placeholder="Old Password">
                    <label for="floatingInput">Old Password</label>
                </div>
                <div class="form-floating">
                    <input name="newPass" type="password" class="form-control" id="floatingPassword" placeholder="New Password">
                    <label for="floatingPassword">New Password</label>
                </div>
                <div class="form-floating">
                    <input name="reNewPass" type="password" class="form-control" id="floatingPassword" placeholder="Re-enter New Password">
