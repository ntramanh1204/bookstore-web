<%-- 
    ...
    Created on : Mar 11, 2024, 5:26:46 PM
    Author     : ADMIN
--%>
            ...
            <div class="container-fluid py-5">
                <div class="container py-5">
                    ...
                    <table class="table">
                        ...
                        <tbody
                            <c:forEach items="${requestScope.listO}" var="a">
                                <tr>
                            <td>
                            ...
                            <td>
                                <p class="mb-0 mt-4">${a.status}</p>
                            </td>
                            <td>

                                <p class="mb-0 mt-4">
                                    <a href="orderDetail?orderID=${a.id}"><button class="btn-primary border-info rounded-pill text-success mb-4" type="button">View Detail</button></a>
                                    <%--<fmt:formatNumber pattern="¤#,##0.00" value="${(a.product.price * a.quantity)}"/>--%>
                                </p>
                            </td>
                            </tr>
                        </c:forEach>
